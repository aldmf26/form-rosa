...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table-action','data' => ['placeholder' => 'cari kategori','filter' => 'true']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['placeholder' => 'cari kategori','filter' => 'true']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.tooltip','data' => ['title' => 'Klik untuk mengaktifkan/nonaktifkan']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Klik untuk mengaktifkan/nonaktifkan']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
        ...
        <tbody>
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $kategori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td><?php echo e($loop->iteration); ?></td>
                    <td><?php echo e($k->nama); ?></td>
                    <td><?php echo e($k->urutan); ?></td>
                    <td><?php echo e($k->produk->count()); ?> item</td>
                    <td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.toggle','data' => ['wire:click' => 'toggleAktif('.e($k->id).')','id' => $k->id,'aktif' => $k->is_active]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'toggleAktif('.e($k->id).')','id' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($k->id),'aktif' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($k->is_active)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                    ...
                    <td>
                        <button wire:click="selectKategori(<?php echo e($k->id); ?>)" type="button"
                            class=" btn btn-sm btn-primary" @click="shakeForm"><i class="fa fa-pen"></i></button>

                        <button @click="nama = '<?php echo e($k->nama); ?>'; id = '<?php echo e($k->id); ?>'; openModal('hapus')"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['idModal' => 'hapus','title' => 'Hapus Data']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['idModal' => 'hapus','title' => 'Hapus Data']); ?>
...
<?php /**PATH C:\laragon\www\kasirok\resources\views/livewire/produk/kategori/index.blade.php ENDPATH**/ ?>