...
<?php $component->withAttributes(['title' => 'Detail Pendaftar']); ?>
    <div class="container py-5">
        <?php if(auth()->guard()->check()): ?>
            ...
            <a href="<?php echo e(url()->previous()); ?>" class="btn btn-success"><i class="fas fa-print"></i> Print</a>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\form-rosa\resources\views/pendaftaran/detail.blade.php ENDPATH**/ ?>