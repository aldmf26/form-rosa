                ...
                <div class="card shadow-lg border-0 rounded-3">
                    <div class="card-body p-5">
                        <div class="d-flex justify-content-center">
                            <img width="200" class="" src="<?php echo e(asset('/images/logo/logo-kasirok.png')); ?>" alt="">
                        </div>
                        ...
                        <form action="<?php echo e(route('login')); ?>" method="POST">
                            ...
                            <div class="text-center">
                                <p class="text-muted">Belum punya akun? 
                                    <a href="<?php echo e(route('register')); ?>" class="text-primary fw-semibold">Daftar Sekarang</a>
                                </p>
                            </div>
                        </form>
                    </div>
...
<?php endif; ?><?php /**PATH C:\laragon\www\kasirok\resources\views/auth/login.blade.php ENDPATH**/ ?>