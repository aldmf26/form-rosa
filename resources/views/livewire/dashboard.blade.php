        ...
        <div class="col-md-4">
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <p class="card-text fs-3"><i class="bi bi-people-fill me-2"></i>{{ $totalPendaftar }}</p>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <p class="card-text fs-3"><i class="bi bi-calendar-event me-2"></i>{{ $pendaftarBulanIni }}</p>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <p class="card-text fs-3"><i class="bi bi-calendar-date me-2"></i>{{ $pendaftarHariIni }}</p>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    new Chart(pendaftarPerBulanCtx, {
        type: 'line',
        data: {
            labels: @json(array_keys($pendaftarPerBulan->toArray())),
            datasets: [{
                label: 'Jumlah Pendaftar',
                data: @json(array_values($pendaftarPerBulan->toArray())),
    ...
    new Chart(statusPendaftarCtx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: @json(array_values($statusPendaftar)),
                backgroundColor: [
                    'rgba(54, 162, 235, 0.7)',
                    'rgba(255, 99, 132, 0.7)',
                ],
    ...
    const daysInMonth = Array.from({ length: {{ Carbon\Carbon::now()->daysInMonth }} }, (_, i) => i + 1); // 1 sampai 31
    new Chart(pendaftarPerHariCtx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: @json(array_values($pendaftarPerHari->toArray())),
